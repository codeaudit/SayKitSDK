...
> If this is the first you're hearing about a so-called "Conversation Manager", you need to stop and learn a bit more about SayKit! [Take a look at our developer resources]({{ "/#developer-resources" | prepend: site.baseurl }}).
...
Now, if you are looking for a bit more help on where to go next: [check out our developer resources]({{ "/#developer-resources" | prepend: site.baseurl }}).
