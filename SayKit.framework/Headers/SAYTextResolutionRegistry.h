...
// TODO - Docs
- (void)registerTemplates:(NSArray<NSString *> *)templates forCommand:(NSString *)commandType;

// TODO - Docs
- (void)registerTemplates:(NSArray<NSString *> *)templates forCommand:(NSString *)commandType withTag:(NSString *)tag;
