 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSearchParameterQuery;
 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSelectParameterItemName;

/**
 *  Parameter dictionary key for a selected item number associated with the SayKit Select command.
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSelectParameterItemNumber;
 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSwitchTabParameterTabName;

/**
 *  Parameter dictionary key for a tab number associated with the SayKit Switch Tab command.
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSwitchTabParameterTabNumber;
 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSetSpeechRateParameterSpeechRate;
 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSetSpeechVolumeParameterSpeechVolume;
 ...
 */
FOUNDATION_EXPORT NSString * const SAYStandardCommandSetVoiceParameterVoice;
