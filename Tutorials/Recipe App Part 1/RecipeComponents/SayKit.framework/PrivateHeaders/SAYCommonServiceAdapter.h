...
@property (nonatomic, copy) NSArray<SAYSpeechIntent *> *cachedIntents;
...
- (void)updateCacheWithText:(NSString *)text completionBlock:(void (^)(NSArray<SAYSpeechIntent *> *))block;
